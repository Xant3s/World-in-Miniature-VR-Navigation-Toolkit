    ...
    public class InstantTravel : TravelStrategy {
        public void Travel(MiniatureModel WIM) {
            ...
            WIM.Data.WIMHeightRelativeToPlayer =
                WIM.transform.position.y -
                WIM.Data.OVRPlayerController.position.y; // Maintain height relative to player.
            var playerHeight = WIM.Data.OVRPlayerController.position.y -
                               MathUtils.GetGroundPosition(WIM.Data.OVRPlayerController.position).y;
            WIM.Data.OVRPlayerController.position =
